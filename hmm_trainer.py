...
def main():
    ...
    save_dict("model/Transition_" + corpus_name + '_' + tagset_name + '_' + smoothing_method + '_' + str(training_perc),  trans_prob)
    save_dict("model/Emission_" + corpus_name + '_' + tagset_name + '_' + str(training_perc), emit_prob)
    time_end = time.time()
    print('=====================')
